...
caso queira você pode fazer todas as alterações criando um script e utilizando o echo para realizar as modificações 

                Aqui estava criando diretorios e grupos do zero, realizei toda essa ação apenas com 1 script 
...
echo "Criando usuários e adicionando eles em seus grupos...."
